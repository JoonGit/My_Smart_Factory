...
namespace My_Smart_Factory.Migrations
{
    ...
    [Migration("20240105115244_OrderStatus_Add")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("My_Smart_Factory.Data.Dto.FullInspRecordDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("FullInspeNo")
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("FullInspRecordDto");
                });

            modelBuilder.Entity("My_Smart_Factory.Data.Dto.Insp.InspEquipSettingRecordDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FullInspRecordDtoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FullInspRecordDtoId");

                    b.ToTable("InspEquipSettingRecordDto");
                });

            modelBuilder.Entity("My_Smart_Factory.Data.Dto.Insp.InspProdRecordDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InspProdRecordDto");
                });

            modelBuilder.Entity("My_Smart_Factory.Data.Vo.FullInsp.FullInspEquipRecordVo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("SpecIES")
                        .HasColumnType("decimal(65,30)");

                    b.HasKey("Id");

                    b.ToTable("FullInspEquipRecordVo");
                });

            modelBuilder.Entity("My_Smart_Factory.Data.Vo.FullInsp.FullInspProdRecordVo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FullInspProdRecordVo");
                });
            ...
            modelBuilder.Entity("My_Smart_Factory.Data.Dto.Insp.InspEquipSettingRecordDto", b =>
                {
                    b.HasOne("My_Smart_Factory.Data.Dto.FullInspRecordDto", null)
                        .WithMany("InspEquipSettingRecordDtos")
                        .HasForeignKey("FullInspRecordDtoId");
                });

            modelBuilder.Entity("My_Smart_Factory.Data.Dto.Insp.InspProdRecordDto", b =>
                {
                    b.HasOne("My_Smart_Factory.Data.Dto.FullInspRecordDto", null)
                        .WithMany("InspProdRecordDtos")
                        .HasForeignKey("FullInspRecordDtoId");
                });
            ...
            modelBuilder.Entity("My_Smart_Factory.Data.Dto.FullInspRecordDto", b =>
                {
                    b.Navigation("InspEquipSettingRecordDtos");

                    b.Navigation("InspProdRecordDtos");
                });
